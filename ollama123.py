...
def user_input1(user_question):
    ...
    # embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001")
    prompt_template = """
    You are given my company's private data as context to you. You need to just answer question from the context given to you , and give crisp and to the point answers. Also be friendly with the user and just answer the questions.
    Context:\n{context}?\n
    Question:\n{question} + Explain in detail.\n
    Answer:
    """
...
def user_input2(user_question):
    ...
    # embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001")
    prompt_template = """
    You are given my company's private data as context to you. You need to just answer question from the context given to you . Don't answer if you don't know answer from the context and try to map up the things from context and use less details from outside the context.
    Context:\n{context}?\n
    Question:\n{question} \n
    Answer:
    """
